                ...
                {NAV_ITEMS.map((item) => {
                  ...
                  if (!hasChildren) {
                    return (
                      ...
                      >
                        <item.icon
                          className={cn("h-4 w-4 shrink-0", parentActive && "text-[#c96442]")}
                        />
                        {item.label}
                      </Link>
                    );
                  ...
                  return (
                    <div key={item.href}>
                      ...
                      >
                        <item.icon
                          className={cn("h-4 w-4 shrink-0", anyChildActive && "text-[#c96442]")}
                        />
                  ...
                  {notifOpen && (
                    <div className="absolute bottom-full left-0 z-50 mb-2 w-80 rounded-2xl border border-[#e8e6dc] bg-white shadow-[0_20px_60px_-20px_rgba(77,76,72,0.2)]">
                      ...
                      <div className="border-t border-[#e8e6dc] px-4 py-2.5">
                        <button
                          type="button"
                          className="text-xs text-[#4d4c48] hover:text-[#141413]"
                        >
                          查看全部通知 →
                        </button>
                      </div>
