...
import {
  AlertTriangle, ArrowDown, ArrowLeft, ArrowRight, ArrowUp, ArrowUpDown, Check,
  CheckCircle2, ChevronDown, ChevronRight, ExternalLink, FileText, Link2, Mail,
  Plus, Search, Send, Trash2, Upload, UploadCloud, X,
} from "lucide-react";
import {
  useWorkspaceProject,
...
interface Creator {
  ...
  followers: number; avgViews: number; avgLikes: number;
  tags: string[]; status: StatusKey; source: SourceKey;
  project: string; projectId?: string; addedAt: string;
}
...
const INIT_CREATORS: Creator[] = [
  // ===== Q2夏季 Campaign =====
  // pending
  { id:"skincare_sam",    handle:"@skincare_sam",       name:"Skincare Sam",       platform:"TikTok",    region:"🇺🇸", followers:320000, avgViews:45000,  avgLikes:3200, tags:["测评","护肤教程"],  status:"待建联", source:"插件收藏", project:"Q2夏季 Campaign", addedAt:"2026-04-10" },
  { id:"fit_jenny",       handle:"@fit_jenny",          name:"Fit Jenny",          platform:"TikTok",    region:"🇺🇸", followers:89000,  avgViews:52000,  avgLikes:4100, tags:["健身","恢复拉伸"],  status:"待评估", source:"搜索收藏", project:"Q2夏季 Campaign", addedAt:"2026-04-12" },
  { id:"beauty_karen",    handle:"@beautytipskaren",    name:"Beauty Tips Karen",  platform:"Instagram", region:"🇺🇸", followers:64000,  avgViews:18000,  avgLikes:2900, tags:["彩妆","护肤"],     status:"待评估", source:"手动导入", project:"Q2夏季 Campaign", addedAt:"2026-04-15" },
  { id:"summer_look",     handle:"@summerlook_daily",   name:"Summer Look Daily",  platform:"TikTok",    region:"🇨🇦", followers:47000,  avgViews:22000,  avgLikes:1800, tags:["夏日穿搭","OOTD"],  status:"待建联", source:"搜索收藏", project:"Q2夏季 Campaign", addedAt:"2026-04-14" },
  { id:"coastline_clara", handle:"@coastline_clara",    name:"Coastline Clara",    platform:"Instagram", region:"🇦🇺", followers:126000, avgViews:36000,  avgLikes:3400, tags:["海边穿搭","生活方式"], status:"待评估", source:"插件收藏", project:"Q2夏季 Campaign", addedAt:"2026-04-16" },
  { id:"denim_mika",      handle:"@denim_mika",         name:"Denim Mika",         platform:"TikTok",    region:"🇯🇵", followers:158000, avgViews:47000,  avgLikes:4300, tags:["夏日穿搭","街头"],   status:"待建联", source:"搜索收藏", project:"Q2夏季 Campaign", addedAt:"2026-04-16" },
  { id:"freshface_jiwon", handle:"@freshface_jiwon",    name:"Freshface Jiwon",    platform:"Instagram", region:"🇰🇷", followers:204000, avgViews:55000,  avgLikes:6200, tags:["韩妆","护肤"],       status:"待评估", source:"插件收藏", project:"Q2夏季 Campaign", addedAt:"2026-04-17" },
  { id:"pilates_may",     handle:"@pilateswithmay",     name:"Pilates With May",   platform:"TikTok",    region:"🇸🇬", followers:97000,  avgViews:33000,  avgLikes:2800, tags:["普拉提","健康生活"], status:"待评估", source:"手动导入", project:"Q2夏季 Campaign", addedAt:"2026-04-16" },
  { id:"minimal_elsa",    handle:"@minimal_elsa",       name:"Minimal Elsa",       platform:"Instagram", region:"🇩🇪", followers:72000,  avgViews:21000,  avgLikes:1900, tags:["极简","OOTD"],      status:"待建联", source:"搜索收藏", project:"Q2夏季 Campaign", addedAt:"2026-04-15" },
  { id:"yoga_nami",       handle:"@yoga_nami_daily",    name:"Yoga Nami Daily",    platform:"YouTube",   region:"🇯🇵", followers:183000, avgViews:49000,  avgLikes:5100, tags:["瑜伽","晨间 routine"], status:"待评估", source:"插件收藏", project:"Q2夏季 Campaign", addedAt:"2026-04-13" },
  { id:"trail_kate",      handle:"@trail_kate",         name:"Trail Kate",         platform:"TikTok",    region:"🇨🇦", followers:54000,  avgViews:24000,  avgLikes:2100, tags:["户外","露营"],       status:"待评估", source:"手动导入", project:"Q2夏季 Campaign", addedAt:"2026-04-12" },
  { id:"beauty_sora",     handle:"@beauty_sora_lab",    name:"Beauty Sora Lab",    platform:"Instagram", region:"🇰🇷", followers:268000, avgViews:69000,  avgLikes:7400, tags:["彩妆教程","测评"],   status:"待建联", source:"插件收藏", project:"Q2夏季 Campaign", addedAt:"2026-04-17" },
  { id:"fit_amelia",      handle:"@fit_amelia_home",    name:"Fit Amelia Home",    platform:"TikTok",    region:"🇬🇧", followers:112000, avgViews:38000,  avgLikes:3300, tags:["居家健身","塑形"],   status:"待评估", source:"搜索收藏", project:"Q2夏季 Campaign", addedAt:"2026-04-14" },
  { id:"sunset_noa",      handle:"@sunset_noa",         name:"Sunset Noa",         platform:"Instagram", region:"🇵🇭", followers:88000,  avgViews:27000,  avgLikes:2500, tags:["海岛风","生活方式"], status:"待评估", source:"手动导入", project:"Q2夏季 Campaign", addedAt:"2026-04-11" },
  { id:"tech_lena",       handle:"@techlena_daily",     name:"Tech Lena Daily",    platform:"YouTube",   region:"🇺🇸", followers:410000, avgViews:118000, avgLikes:9300, tags:["数码","桌搭"],       status:"待建联", source:"插件收藏", project:"Q2夏季 Campaign", addedAt:"2026-04-16" },
  { id:"cafe_hana",       handle:"@cafehana_weekend",   name:"Cafe Hana Weekend",  platform:"TikTok",    region:"🇹🇭", followers:66000,  avgViews:26000,  avgLikes:2200, tags:["探店","生活方式"],   status:"待评估", source:"搜索收藏", project:"Q2夏季 Campaign", addedAt:"2026-04-13" },
  // active
  { id:"glow_girl",       handle:"@glow_girl",          name:"Glow Girl",          platform:"TikTok",    region:"🇺🇸", followers:180000, avgViews:28000,  avgLikes:2100, tags:["GRWM","平价好物"],  status:"已建联", source:"插件收藏", project:"Q2夏季 Campaign", addedAt:"2026-04-08" },
  { id:"style_nina",      handle:"@style_nina_official",name:"Style Nina",         platform:"Instagram", region:"🇬🇧", followers:230000, avgViews:41000,  avgLikes:6200, tags:["时尚","穿搭"],     status:"合作中", source:"搜索收藏", project:"Q2夏季 Campaign", addedAt:"2026-04-03" },
  { id:"daily_delight",   handle:"@dailydelight_amy",   name:"Daily Delight Amy",  platform:"TikTok",    region:"🇨🇦", followers:115000, avgViews:33000,  avgLikes:3800, tags:["日常","美食"],     status:"已建联", source:"插件收藏", project:"Q2夏季 Campaign", addedAt:"2026-04-06" },
  // archived
  { id:"office_hacks",    handle:"@office_life_hacks",  name:"Office Life Hacks",  platform:"TikTok",    region:"🇺🇸", followers:156000, avgViews:29000,  avgLikes:2200, tags:["办公","效率工具"],  status:"已完成", source:"搜索收藏", project:"Q2夏季 Campaign", addedAt:"2026-03-28" },
  { id:"run_rachel",      handle:"@run_with_rachel",    name:"Run With Rachel",    platform:"YouTube",   region:"🇺🇸", followers:78000,  avgViews:22000,  avgLikes:1900, tags:["跑步","运动"],     status:"已排除", source:"手动导入", project:"Q2夏季 Campaign", addedAt:"2026-03-20" },

  // ===== 美妆博主池 =====
  // pending
  { id:"viral_beauty",    handle:"@viral_beauty",       name:"Viral Beauty",       platform:"Instagram", region:"🇬🇧", followers:45000,  avgViews:38000,  avgLikes:1800, tags:["成分分析","平价好物"],status:"待评估", source:"手动导入", project:"美妆博主池", addedAt:"2026-04-14" },
  { id:"skinlab_uk",      handle:"@skinlab_uk",         name:"SkinLab UK",         platform:"TikTok",    region:"🇬🇧", followers:92000,  avgViews:31000,  avgLikes:4600, tags:["成分党","测评"],    status:"待评估", source:"搜索收藏", project:"美妆博主池", addedAt:"2026-04-13" },
  { id:"rosy_glow",       handle:"@rosyglow_official",  name:"Rosy Glow",          platform:"Instagram", region:"🇺🇸", followers:128000, avgViews:24000,  avgLikes:5300, tags:["护肤","天然成分"],  status:"待建联", source:"插件收藏", project:"美妆博主池", addedAt:"2026-04-11" },
  { id:"velvet_look",     handle:"@velvetlook_paris",   name:"Velvet Look Paris",  platform:"TikTok",    region:"🇫🇷", followers:71000,  avgViews:19500,  avgLikes:3100, tags:["法式美妆","底妆"],  status:"待评估", source:"插件收藏", project:"美妆博主池", addedAt:"2026-04-10" },
  // active
  { id:"glam_studio",     handle:"@glamstudio_hk",      name:"Glam Studio HK",     platform:"TikTok",    region:"🇭🇰", followers:310000, avgViews:67000,  avgLikes:9100, tags:["彩妆教程","仿妆"],  status:"已建联", source:"插件收藏", project:"美妆博主池", addedAt:"2026-04-02" },
  { id:"beauty_de",       handle:"@beautylife_de",      name:"Beauty Life DE",     platform:"Instagram", region:"🇩🇪", followers:87000,  avgViews:19000,  avgLikes:3200, tags:["德系护肤","成分"],  status:"合作中", source:"搜索收藏", project:"美妆博主池", addedAt:"2026-04-01" },
  // archived
  { id:"beauty_uk",       handle:"@beautyinsider_uk",   name:"Beauty Insider UK",  platform:"Instagram", region:"🇬🇧", followers:98000,  avgViews:15000,  avgLikes:3400, tags:["护肤","彩妆"],     status:"已排除", source:"插件收藏", project:"美妆博主池", addedAt:"2026-04-01" },
  { id:"glow_matcha",     handle:"@glowmatcha",         name:"Glow Matcha",        platform:"YouTube",   region:"🇦🇺", followers:53000,  avgViews:12000,  avgLikes:980,  tags:["天然护肤","纯素"],  status:"已完成", source:"手动导入", project:"美妆博主池", addedAt:"2026-03-25" },
  { id:"luxe_skin",       handle:"@luxeskin_paris",     name:"Luxe Skin Paris",    platform:"TikTok",    region:"🇫🇷", followers:195000, avgViews:48000,  avgLikes:7200, tags:["法式护肤","高端"],  status:"已完成", source:"搜索收藏", project:"美妆博主池", addedAt:"2026-03-18" },

  // ===== 未分配 (末位) =====
  // pending
  { id:"tech_review_yt",  handle:"@techreviewer_pro",   name:"Tech Reviewer Pro",  platform:"YouTube",   region:"🇺🇸", followers:520000, avgViews:120000, avgLikes:8500, tags:["科技测评","开箱"],  status:"待评估", source:"手动导入", project:"未分配", addedAt:"2026-04-15" },
  { id:"food_diary_sg",   handle:"@fooddiary_sg",       name:"Food Diary SG",      platform:"TikTok",    region:"🇸🇬", followers:71000,  avgViews:28000,  avgLikes:3100, tags:["美食","探店"],     status:"待评估", source:"插件收藏", project:"未分配", addedAt:"2026-04-16" },
  { id:"yoga_sara",       handle:"@yogawithsara",       name:"Yoga With Sara",     platform:"Instagram", region:"🇺🇸", followers:144000, avgViews:35000,  avgLikes:5600, tags:["瑜伽","健康生活"],  status:"待建联", source:"搜索收藏", project:"未分配", addedAt:"2026-04-14" },
  // active
  { id:"camp_mike",       handle:"@camp_mike",          name:"Camp Mike",          platform:"TikTok",    region:"🇺🇸", followers:210000, avgViews:38000,  avgLikes:5100, tags:["户外","露营"],     status:"合作中", source:"搜索收藏", project:"未分配", addedAt:"2026-04-05" },
  { id:"home_jasmine",    handle:"@homedeco_jasmine",   name:"HomeDeco Jasmine",   platform:"Instagram", region:"🇦🇺", followers:163000, avgViews:27000,  avgLikes:4400, tags:["家居","室内设计"],  status:"已建联", source:"手动导入", project:"未分配", addedAt:"2026-04-09" },
  // archived
  { id:"vintage_viv",     handle:"@vintagevivian",      name:"Vintage Vivian",     platform:"TikTok",    region:"🇬🇧", followers:88000,  avgViews:19000,  avgLikes:2800, tags:["古着","二手时尚"],  status:"已完成", source:"插件收藏", project:"未分配", addedAt:"2026-03-30" },
  { id:"quickcook_tom",   handle:"@quickcook_tom",      name:"QuickCook Tom",      platform:"YouTube",   region:"🇨🇦", followers:267000, avgViews:58000,  avgLikes:7300, tags:["快手菜","家常"],    status:"已排除", source:"搜索收藏", project:"未分配", addedAt:"2026-03-22" },
];
...
export default function LibraryPage() {
  ...
  const handleMoveTo = (targetProjectId: string) => {
    ...
    setCreators(prev => prev.map(c =>
      selectedIds.includes(c.id) ? { ...c, projectId: targetProjectId, project: targetProjectName } : c
    ));
    setSelectedIds([]);
  ...
  const closePopovers = () => {
    setOpenFilter(null); setDeletingId(null); setStatusPopId(null);
  };
  ...
  let displayed = creators.filter(c => {
    ...
    if (search) {
      ...
      if (!c.handle.toLowerCase().includes(q) &&
  ...
  const tabCount    = (t: PriorityTab) => creators.filter(c => (c.projectId ?? WORKSPACE_UNASSIGNED_PROJECT_ID) === currentProjectId && PRIORITY[t].includes(c.status)).length;
  const projCount   = (projectId: string) => creators.filter(c => (c.projectId ?? WORKSPACE_UNASSIGNED_PROJECT_ID) === projectId).length;
    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <button type="button" onClick={() => setImportOpen(true)}
          ...
          <Upload className="h-3.5 w-3.5" />导入名单
        </button>
      </div>
      ...
      <div className="flex items-center gap-1 rounded-2xl border border-[#e8e6dc] bg-white p-1.5">
        {projects.map(project => (
          <button key={project.id} type="button"
            onClick={() => { selectProject(project.id); setSelectedIds([]); }}
            className={cn(
            ...
            <span className={cn(
              ...
              currentProjectId === project.id ? "bg-white/20 text-white" : "bg-[#f0ece4] text-[#87867f]"
            )}>{projCount(project.id)}</span>
          </button>
        ))}

        <div className="ml-auto flex items-center gap-2">
          <button type="button" onClick={() => openCreateProject("quick")}
            ...
            <Plus className="h-3.5 w-3.5" />快捷新建
          </button>
          <button type="button" onClick={() => openCreateProject("detailed")}
            ...
            <Plus className="h-3.5 w-3.5" />详细新建
          </button>
        </div>
      </div>
          ...
          <div className="flex items-center">
            {([
              ...
              <button key={t.key} type="button" title={t.hint}
                onClick={() => { setPriorityTab(t.key); setSelectedIds([]); setBatchBarDismissed(false); }}
                className={cn(
                ...
                <span className={cn(
                  "rounded-full px-1.5 py-px text-[10px]",
                  priorityTab === t.key ? "bg-[#fdf5f0] text-[#c96442]" : "bg-[#f5f4ed] text-[#87867f]"
                )}>{tabCount(t.key)}</span>
              </button>
            ))}
          </div>
          ...
          {showBatchBar && (
            <div className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
              <div className="pointer-events-auto flex items-center gap-3 rounded-2xl border border-[#e8e6dc] bg-white px-5 py-3 shadow-[0_20px_60px_-20px_rgba(77,76,72,0.22)]">
                <span className="text-sm text-[#141413]">已选 <span className="font-semibold">{selectedIds.length}</span> 人</span>
                ...
                <button type="button" onClick={() => setBatchBarDismissed(true)}
      ...
      <div className="flex flex-wrap items-center gap-2">
        <div className="relative min-w-[180px] flex-1">
          ...
          <input value={search} onChange={e => setSearch(e.target.value)}
            ...
            className="w-full rounded-xl border border-[#e8e6dc] bg-white py-2 pl-8 pr-3 text-sm text-[#141413] placeholder:text-[#87867f] focus:border-[#c96442]/40 focus:outline-none" />
        </div>

        <FilterChip label={fPlatform ?? "平台"} active={!!fPlatform} open={openFilter === "platform"} onToggle={() => setOpenFilter(openFilter === "platform" ? null : "platform")}>
          <ChipItem label="全部平台" onClick={() => { setFPlatform(null); setOpenFilter(null); }} />
          {PLATFORMS.map(p => <ChipItem key={p} label={p} active={fPlatform === p} onClick={() => { setFPlatform(p); setOpenFilter(null); }} />)}
        </FilterChip>

        <FilterChip label={fStatus ?? "状态"} active={!!fStatus} open={openFilter === "status"} onToggle={() => setOpenFilter(openFilter === "status" ? null : "status")}>
          <ChipItem label="全部状态" onClick={() => { setFStatus(null); setOpenFilter(null); }} />
          {ALL_STATUSES.map(s => <ChipItem key={s} label={s} active={fStatus === s}
            onClick={() => { setFStatus(s); setOpenFilter(null); }}
            prefix={<span className={cn("h-1.5 w-1.5 rounded-full shrink-0", STATUS_CFG[s].dot)} />} />)}
        </FilterChip>

        <FilterChip label={fSource ?? "来源"} active={!!fSource} open={openFilter === "source"} onToggle={() => setOpenFilter(openFilter === "source" ? null : "source")}>
          <ChipItem label="全部来源" onClick={() => { setFSource(null); setOpenFilter(null); }} />
          {SOURCES.map(s => <ChipItem key={s} label={s} active={fSource === s} onClick={() => { setFSource(s); setOpenFilter(null); }} />)}
        </FilterChip>

        <FilterChip label={fTag || "标签"} active={!!fTag} open={openFilter === "tag"} onToggle={() => setOpenFilter(openFilter === "tag" ? null : "tag")} extraPadding>
          <input placeholder="搜索标签..." value={fTag} onChange={e => setFTag(e.target.value)}
          ...
          {allTags.filter(t => !fTag || t.includes(fTag)).length === 0
            ...
            : allTags.filter(t => !fTag || t.includes(fTag)).map(t =>
                <ChipItem key={t} label={t} active={fTag === t} onClick={() => { setFTag(t); setOpenFilter(null); }} />
              )}
          {fTag && <button type="button" onClick={() => setFTag("")}
        ...
        {hasFilters && (
          <button type="button" onClick={() => { setFPlatform(null); setFStatus(null); setFSource(null); setFTag(""); }}
      ...
      <div className="rounded-2xl border border-[#e8e6dc] bg-white">
        ...
        {/* Header */}
        <div className="grid items-center gap-2 rounded-t-2xl border-b border-[#e8e6dc] bg-[#faf9f5] px-4 py-2.5 text-xs font-medium text-[#87867f]"
          style={{ gridTemplateColumns: GRID }}>
          <input type="checkbox" className="h-3.5 w-3.5 accent-[#c96442]" checked={allSelected}
            onChange={e => toggleSelectAll(e.target.checked)} />
          <span>博主</span><span>平台</span><span>近期内容</span>
          {([["followers","粉丝"],["avgViews","均播放"],["avgLikes","均点赞"]] as [SortKey,string][]).map(([k, label]) => (
            <button key={k} type="button" onClick={() => handleSort(k)}
              className="flex items-center gap-1 text-left hover:text-[#141413] transition-colors">
              {label}
              {sortKey === k ? (sortDir === "desc" ? <ArrowDown className="h-3 w-3" /> : <ArrowUp className="h-3 w-3" />) : <ArrowUpDown className="h-3 w-3 opacity-40" />}
            </button>
          ))}
          <span>项目</span><span>来源</span><span>状态</span><span />
        </div>

        {/* Empty state */}
        {displayed.length === 0 && (
          <div className="rounded-b-2xl py-14 text-center text-sm text-[#87867f]">暂无符合条件的博主</div>
        )}
        ...
        {displayed.map((c, rowIdx) => {
          ...
          return (
            <div key={c.id}
              ...
              <input type="checkbox" checked={isSelected} className="h-3.5 w-3.5 accent-[#c96442]"
                onChange={() => toggleCreatorSelection(c.id)} />

              {/* Creator */}
              <div className="flex min-w-0 items-center gap-2.5">
                <button type="button" onClick={() => openCreatorProfile(creatorToProfile(c))} className="shrink-0 rounded-full transition-transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#c96442] focus:ring-offset-1">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img src={avatarSrc(c.id)} alt={c.name} width={36} height={36}
                ...
                <div className="min-w-0">
                  ...
                  <div className="mt-0.5 flex flex-wrap gap-1">
                    {c.tags.slice(0, 2).map(t => (
                      <span key={t} className="rounded-full bg-[#f5f4ed] px-1.5 py-px text-[10px] text-[#87867f]">{t}</span>
                    ))}
                  </div>
                </div>
              </div>
              ...
              <div className="text-xs leading-snug text-[#87867f]">
                <div>{c.region}</div><div className="mt-0.5">{c.platform}</div>
              </div>

              {/* Thumbnails — real photos from picsum, fallback gradient */}
              <div className="flex gap-1">
                {[0, 1, 2].map(i => (
                  <a key={i} href="https://www.tiktok.com" target="_blank" rel="noopener noreferrer"
                    title="点击查看视频"
                    ...
                    <ExternalLink className="absolute bottom-0.5 right-0.5 h-2 w-2 text-white opacity-0 drop-shadow transition-opacity group-hover:opacity-100" />
                  </a>
                ))}
              </div>
              ...
              {/* Project */}
              <span className="truncate text-xs text-[#87867f]" title={projectLabel}>{projectLabel}</span>
              ...
              <div className="relative">
                <button type="button"
                  ...
                  {c.status}<ChevronDown className="h-2.5 w-2.5" />
                </button>
                {statusPopId === c.id && (
                  <div className={cn(
              ...
              {/* Delete */}
              <div className="relative">
                <button type="button" onClick={() => setDeletingId(deletingId === c.id ? null : c.id)}
                  className="flex h-7 w-7 items-center justify-center rounded-lg text-[#87867f] hover:bg-red-50 hover:text-red-500">
                  <Trash2 className="h-3.5 w-3.5" />
                </button>
                {deletingId === c.id && (
                  <div className="absolute right-0 top-8 z-30 w-40 rounded-2xl border border-[#e8e6dc] bg-white p-3.5 shadow-xl">
                    <p className="text-xs text-[#4d4c48]">确认删除此博主？</p>
                    <div className="mt-3 flex gap-2">
                      <button type="button" onClick={() => confirmDelete(c.id)}
                        className="flex-1 rounded-lg bg-red-500 py-1.5 text-xs font-medium text-white hover:bg-red-600">确认</button>
                      <button type="button" onClick={() => setDeletingId(null)}
                        className="flex-1 rounded-lg border border-[#e8e6dc] py-1.5 text-xs text-[#4d4c48] hover:bg-[#f5f4ed]">取消</button>
                    </div>
                  </div>
                )}
              </div>
      ...
      <p className="text-xs text-[#87867f]">
        显示 {displayed.length} 条 · 共 {creators.filter(c => (c.projectId ?? WORKSPACE_UNASSIGNED_PROJECT_ID) === currentProjectId && tabStatuses.includes(c.status)).length} 条
      </p>
      {/* ── 移入项目 modal ───────────────────────────────────────────────────── */}
      {moveModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          <div className="w-80 rounded-2xl border border-[#e8e6dc] bg-white p-6 shadow-2xl">
            ...
            <p className="mb-4 text-xs text-[#87867f]">为已选 <span className="font-medium text-[#141413]">{selectedIds.length}</span> 位博主选择目标项目</p>

            <div className="mb-4 space-y-2">
              {projects.filter(project => project.id !== currentProjectId).map(project => (
                <button key={project.id} type="button" onClick={() => handleMoveTo(project.id)}
          ...
          <div className="fixed inset-0 z-[-1] bg-black/10" onClick={() => { setMoveModalOpen(false); }} />
        </div>
      )}
      ...
      {batchOutreachOpen && (
        <BatchOutreachDrawer
          ...
          onComplete={(ids) => {
            setCreators(prev => prev.map(c => ids.includes(c.id) ? { ...c, status: "已建联" } : c));
            setSelectedIds([]);
...
const BATCH_TEMPLATES = [
  ...
  { id: 3, name: "独家合作",  replyRate: 18, subject: "Exclusive partnership opportunity from {brand_name}" },
  { id: 4, name: "二次催促",  replyRate: 9,  subject: "Following up — {brand_name} × {creator_name}" },
];

function BatchOutreachDrawer({ creators, onClose, onComplete }: {
  creators: Creator[];
  onClose: () => void;
        ...
        <div className="flex items-center justify-between border-b border-[#e8e6dc] px-6 py-4">
          <div>
            ...
            <p className="mt-0.5 text-xs text-[#87867f]">
              {step === 1 ? "Step 1 · 确认建联博主" : step === 2 ? "Step 2 · 选择邮件模板" : "Step 3 · 确认发送"}
            </p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          ...
          {step === 1 && (
            <div className="space-y-3">
              <p className="text-xs text-[#87867f]">确认以下 <span className="font-medium text-[#141413]">{list.length}</span> 位博主参与建联，可点击 × 移除</p>
              {list.length === 0 && (
              ...
              {list.map(c => (
                <div key={c.id} className="flex items-center gap-3 rounded-xl border border-[#e8e6dc] bg-[#faf9f5] px-4 py-3">
                  <button type="button" onClick={() => openCreatorProfile(creatorToProfile(c))} className="shrink-0 rounded-full transition-transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-[#c96442] focus:ring-offset-1">
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img src={avatarSrc(c.id)} alt={c.name} width={36} height={36}
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="truncate text-sm font-medium text-[#141413]">{c.handle}</div>
                    <div className="mt-0.5 text-[10px] text-[#87867f]">{c.platform} · {c.region}</div>
                  </div>
                  <button type="button" onClick={() => removeCreator(c.id)}
          ...
          {step === 2 && (
            <div className="space-y-3">
              ...
              {BATCH_TEMPLATES.map(t => (
                <div key={t.id}>
                  <button type="button"
                    onClick={() => { setSelTemplate(t.id); setExpandedId(expandedId === t.id ? null : t.id); }}
                    className={cn(
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-2.5">
                        <div className={cn(
                          ...
                          selTemplate === t.id ? "border-[#c96442] bg-[#c96442]" : "border-[#d4d2cc]"
                        )}>
                        ...
                        <div className="flex gap-1.5">
                          {list.slice(0, 4).map((c, i) => (
                            <button key={c.id} type="button"
                              ...
                              <img src={avatarSrc(c.id)} alt={c.name} width={24} height={24} className="h-full w-full" />
                            </button>
                          ))}
                        </div>
                        {list[previewIdx] && (
                          <span className="text-[10px] text-[#4d4c48]">{list[previewIdx].handle}</span>
                        )}
                      </div>
                      <div className="rounded-lg bg-white p-3 text-xs text-[#4d4c48] leading-relaxed">
                        <div className="mb-2 font-medium text-[#141413]">
                          {t.subject.replace("{creator_name}", list[previewIdx]?.name ?? "Creator").replace("{platform}", list[previewIdx]?.platform ?? "TikTok").replace("{brand_name}", "MyBrand")}
                        </div>
                        <div className="text-[#87867f]">
                          Hi {list[previewIdx]?.name ?? "Creator"},<br /><br />
                          我是 MyBrand 的 Sarah，非常欣赏您在 {list[previewIdx]?.platform ?? "TikTok"} 上的内容创作。希望邀请您参与我们 Q2 夏季新品的合作推广...
                        </div>
                      </div>
                    </div>
                  )}
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {list.map(c => (
                    <div key={c.id} className="flex items-center gap-1.5 rounded-full border border-[#e8e6dc] bg-white px-2.5 py-1">
                      <img src={avatarSrc(c.id)} alt={c.name} width={16} height={16}
        ...
        <div className="border-t border-[#e8e6dc] px-6 py-4">
          {step === 1 && (
            <div className="flex gap-2">
              ...
              <button type="button" disabled={list.length === 0} onClick={() => setStep(2)}
                ...
                下一步：选择模板<ChevronRight className="h-3.5 w-3.5" />
              </button>
            </div>
          )}
          {step === 2 && (
            <div className="flex gap-2">
              ...
              <button type="button" disabled={selTemplate === null} onClick={() => setStep(3)}
                className="flex flex-1 items-center justify-center gap-1.5 rounded-xl bg-[#141413] py-2.5 text-sm font-medium text-white hover:bg-[#2a2a28] disabled:opacity-40">
                下一步：确认发送<ChevronRight className="h-3.5 w-3.5" />
              </button>
            </div>
          )}
          {step === 3 && (
            <div className="flex gap-2">
              ...
              <button type="button" onClick={() => onComplete(list.map(c => c.id))}
                ...
                <Send className="h-3.5 w-3.5" />启动发送
              </button>
            </div>
          )}
        </div>
...
// ── Sub-components ─────────────────────────────────────────────────────────────
function FilterChip({ label, active, open, onToggle, extraPadding = false, children }: {
  label: string; active: boolean; open: boolean; onToggle: () => void;
  extraPadding?: boolean; children: React.ReactNode;
}) {
  return (
    <div className="relative">
      <button type="button" onClick={onToggle}
        className={cn(
          ...
          active ? "border-[#c96442]/30 bg-[#fdf5f0] text-[#c96442]"
...
function ChipItem({ label, active = false, onClick, prefix }: {
  label: string; active?: boolean; onClick: () => void; prefix?: React.ReactNode;
}) {
  return (
...
const MOCK_PREVIEW_ROWS: ImportRow[] = [
  { key: "imp_skincare_sam",   handle: "@skincare_sam",    platform: "TikTok",    followers: 320000, avgViews: 45000, avgLikes: 3200, tags: ["测评","护肤"], status: "ok",    statusNote: "信息完整，可直接导入" },
  { key: "imp_fit_jenny",      handle: "@fit_jenny",       platform: "TikTok",    followers: 89000,  avgViews: 52000, avgLikes: 4100, tags: ["健身"],       status: "ok",    statusNote: "信息完整，可直接导入" },
  { key: "imp_glow_girl",      handle: "@glow_girl",       platform: "Instagram", followers: 156000, avgViews: null,  avgLikes: null, tags: ["护肤"],       status: "warn",  statusNote: "部分字段缺失，可手动填写" },
  { key: "imp_unknown_user",   handle: "@unknown_user",    platform: "",          followers: null,   avgViews: null,  avgLikes: null, tags: [],             status: "error", statusNote: "链接无效，该行置灰，无法导入" },
];
...
function ImportModal({ onClose, onComplete }: {
  ...
  const handleRowEdit = (key: string, field: keyof ImportRow, value: string) => {
    setRows(prev => prev.map(r => {
      ...
      if (updated.status === "warn" && updated.followers && updated.avgViews && updated.avgLikes) {
        updated.status = "ok";
            ...
            return (
              <div key={s} className="flex items-center gap-2">
                <div className={cn(
                  ...
                  isActive ? "bg-[#c96442] text-white"
                  : isPast  ? "bg-[#c96442]/20 text-[#c96442]"
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          {step === "method" && (
            <div className="space-y-3">
              ...
              <MethodOption active={method === "profile"} onClick={() => setMethod("profile")}
                ...
                {method === "profile" && (
                  <div className="mt-3 space-y-1.5">
                    <textarea value={profileText} onChange={e => setProfileText(e.target.value)}
                      rows={4}
                      placeholder={"每行粘贴一个链接，支持批量输入\nhttps://www.tiktok.com/@skincare_sam\nhttps://www.instagram.com/fit_jenny\n..."}
                      className="w-full rounded-xl border border-[#e8e6dc] bg-white px-3.5 py-2.5 font-mono text-xs text-[#141413] placeholder:text-[#c8c7c3] focus:border-[#c96442]/40 focus:outline-none focus:ring-2 focus:ring-[#c96442]/15" />
              ...
              {/* Option 2 — Post links */}
              <MethodOption active={method === "post"} onClick={() => setMethod("post")}
              ...
              {/* Option 3 — CSV upload */}
              <MethodOption active={method === "csv"} onClick={() => setMethod("csv")}
                ...
                {method === "csv" && (
                  <div className="mt-3 space-y-2.5">
                    <button type="button"
                      ...
                      <FileText className="h-3.5 w-3.5" />下载 CSV 模板
                    </button>
                    <label className={cn(
                      ...
                      <UploadCloud className={cn("h-5 w-5", fileName ? "text-[#c96442]" : "text-[#87867f]")} />
                      {fileName ? (
                        <>
                        ...
                        <>
                          ...
                          <span className="text-[10px] text-[#87867f]">模板必填列：@ID · 平台 · 可选列：粉丝数 / 均播放 / 均点赞 / 标签</span>
                        </>
                      )}
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-2xl border border-[#e8e6dc] bg-white p-3.5">
                <div className="flex items-center justify-between text-xs">
                  ...
                  <span className="text-[#87867f]">{rows.length} / {MOCK_PREVIEW_ROWS.length}</span>
                </div>
                ...
                {!fetching && (
                  <div className="mt-3 flex items-center gap-3 border-t border-[#f0ece4] pt-2.5 text-[11px]">
                    <span className="flex items-center gap-1 text-[#5a6a4a]"><Check className="h-3 w-3" />{okCount} 成功</span>
                    <span className="flex items-center gap-1 text-[#c96442]"><AlertTriangle className="h-3 w-3" />{warnCount} 警告</span>
                    <span className="flex items-center gap-1 text-[#87867f]"><X className="h-3 w-3" />{errCount} 失败</span>
                  </div>
                )}
              </div>
              ...
              {!fetching && rows.length > 0 && (
                <div className="overflow-hidden rounded-2xl border border-[#e8e6dc] bg-white">
                  <div className="grid grid-cols-[24px_minmax(0,1.6fr)_88px_72px_72px_72px] gap-2 border-b border-[#e8e6dc] bg-[#faf9f5] px-3 py-2 text-[10px] font-medium uppercase tracking-wide text-[#87867f]">
                    <span></span>
                    <span>博主</span>
                    <span>平台</span>
                    ...
                    return (
                      <div key={r.key}
                        ...
                        <span>
                          ...
                          {r.status === "warn" && <AlertTriangle className="h-3 w-3 text-[#c96442]" />}
                          {r.status === "error" && <X className="h-3 w-3 text-[#87867f]" />}
                        </span>
                        <div className="flex items-center gap-2 min-w-0">
                          <button type="button" onClick={() => openCreatorProfile({ name: r.handle, handle: r.handle, avatarUrl: avatarSrc(r.handle.replace("@","")), region: "--", followers: r.followers != null ? fmtFollowers(r.followers) : "--", er: "--" })} className="shrink-0 rounded-full transition-transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-[#c96442] focus:ring-offset-1">
                            {/* eslint-disable-next-line @next/next/no-img-element */}
                            <img src={avatarSrc(r.handle.replace("@",""))} alt=""
                              className="h-6 w-6 rounded-full ring-1 ring-[#e8e6dc]" />
                          </button>
                          <span className={cn("truncate font-mono", isErr ? "text-[#87867f]" : "text-[#141413]")}>{r.handle}</span>
                        </div>
                        <span className={cn(r.platform ? "text-[#4d4c48]" : "text-[#c96442]")}>{r.platform || "未知"}</span>
                        {(["followers","avgViews","avgLikes"] as const).map(f => {
                          ...
                          if (isEditing) {
                            return (
                              <input key={f} autoFocus type="text" defaultValue={value === null ? "" : String(value)}
                                onBlur={e => handleRowEdit(r.key, f, e.target.value)}
                                onKeyDown={e => {
                                  if (e.key === "Enter") handleRowEdit(r.key, f, (e.target as HTMLInputElement).value);
                          ...
                          return (
                            <button key={f} type="button"
                              ...
                              className={cn(
                                ...
                                missing && isWarn && "bg-[#fbf5ed] px-1.5 py-0.5 text-[#c96442] ring-1 ring-[#f5e4d1] hover:bg-[#f5e4d1]",
                                !missing && "text-[#141413]",
                                isErr && "text-[#87867f]"
                              )}>
                              {fmtCount(value)}
          ...
          {step === "assign" && (
            <div className="space-y-4">
              {/* Target project */}
              <div>
                <label className="text-xs font-medium text-[#4d4c48]">归属项目 <span className="text-[#c96442]">*</span></label>
                <select value={targetProject} onChange={e => setTargetProject(e.target.value)}
                  className="mt-1.5 w-full rounded-xl border border-[#e8e6dc] bg-white px-3.5 py-2.5 text-sm text-[#141413] focus:border-[#c96442]/40 focus:outline-none focus:ring-2 focus:ring-[#c96442]/15">
              ...
              <div>
                ...
                <div className="mt-1.5 flex flex-wrap items-center gap-1.5 rounded-xl border border-[#e8e6dc] bg-white px-2.5 py-2">
                  {customTags.map(t => (
                    <span key={t} className="flex items-center gap-1 rounded-full bg-[#fbf5ed] px-2 py-0.5 text-[11px] text-[#c96442] ring-1 ring-[#f5e4d1]">
                      {t}
                      <button type="button" onClick={() => setCustomTags(prev => prev.filter(x => x !== t))}>
                  ...
                  <input value={newTag} onChange={e => setNewTag(e.target.value)}
                    ...
                    placeholder={customTags.length ? "" : "+ 添加标签，回车确认（已选：护肤 / 美妆）"}
                    className="flex-1 min-w-[140px] bg-transparent text-xs text-[#141413] placeholder:text-[#87867f] focus:outline-none" />
                </div>
              </div>
                ...
                <div className="mt-1.5 space-y-1.5">
                  {(["待评估"] as const).map(s => (
                    <label key={s}
                      ...
                      <input type="radio" checked={initStatus === s} onChange={() => setInitStatus(s)}
                        className="h-3.5 w-3.5 accent-[#c96442]" />
                      <span className={cn("font-medium", initStatus === s ? "text-[#c96442]" : "text-[#141413]")}>
                        设为待评估
                      </span>
                    </label>
                  ))}
              ...
              <div className="rounded-2xl border border-[#e8e6dc] bg-white p-4">
                ...
                <ul className="space-y-1 text-[11px] text-[#5e5d59]">
                  <li className="flex items-center gap-2">
                    <Check className="h-3 w-3 text-[#5a6a4a]" />
                    将导入 <span className="font-semibold text-[#141413]">{validRows.length}</span> 位博主至「<span className="font-medium text-[#c96442]">{resolveProjectName(targetProject)}</span>」
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="h-3 w-3 text-[#5a6a4a]" />
                    来源标注为：手动导入
                  ...
                  {customTags.length > 0 && (
                    <li className="flex items-start gap-2">
                      ...
                      <span>附加标签：<span className="text-[#141413]">{customTags.join(" · ")}</span></span>
                    </li>
                  )}
                </ul>
              </div>
        ...
        <div className="flex items-center justify-between border-t border-[#e8e6dc] bg-[#f5f4ed] px-6 py-3.5">
          {step === "method" ? (
            <>
              ...
              <button type="button" onClick={handleNextFromMethod}
            ...
            <>
              ...
              <div className="flex gap-2">
                {errCount > 0 && (
                  <button type="button" onClick={handleSkipErrors}
                    className="rounded-xl border border-[#e8e6dc] bg-white px-4 py-2 text-sm text-[#4d4c48] hover:bg-[#faf9f5]">
                    跳过无效项，继续
                  </button>
                )}
...
function MethodOption({ active, onClick, icon, title, badge, desc, children }: {
  active: boolean;
  onClick: () => void;
    ...
    <div className={cn(
      ...
      <button type="button" onClick={onClick}
        ...
        <div className={cn(
          ...
          active ? "bg-[#fbf5ed] text-[#c96442] ring-1 ring-[#f5e4d1]" : "bg-[#faf9f5] text-[#87867f] ring-1 ring-[#e8e6dc]"
        )}>
          {icon}
        </div>
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            <span className={cn("text-sm font-medium", active ? "text-[#141413]" : "text-[#4d4c48]")}>{title}</span>
            {badge && (
              <span className="rounded-full bg-[#fbf5ed] px-2 py-0.5 text-[10px] font-medium text-[#c96442] ring-1 ring-[#f5e4d1]">
                {badge}
              </span>
