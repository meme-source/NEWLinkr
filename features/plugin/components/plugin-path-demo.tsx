...
import { SimilarSidebarCurrentPanel } from "@/features/plugin/components/similar-sidebar-current-panel";
import {
  formatComments,
  formatLikes,
  formatPlays,
        ...
        >
          ...
          {activeSidebarTab === "current" ? (
            <SimilarSidebarCurrentPanel
              ...
              onSelectDetailTab={setCurrentDetailTab}
              ...
              onCloseMetricsRangeMenu={() => setMetricsRangeMenuOpen(false)}
              scrapeCount={scrapeCount}
              onChangeScrapeCount={onChangeScrapeCount}
