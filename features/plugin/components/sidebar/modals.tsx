  ...
  return (
    ...
    >
      <div
        ...
        aria-modal="true"
        aria-label="确认删除项目"
        className="relative w-full max-w-sm overflow-hidden rounded-[24px] border border-[#c5c0b1] bg-[#fffefb] p-6 text-[#201515]"
      >
        ...
        <div className="mt-5 flex items-center justify-end gap-2">
          <button
            type="button"
            onClick={onCancel}
            className="rounded-full border border-[#c5c0b1] bg-[#fffefb] px-4 py-1.5 text-[13px] font-medium text-[#36342e] transition-colors hover:border-[#c5c0b1] hover:bg-[#eceae3]"
          >
            取消
          </button>
          <button
            type="button"
            onClick={onConfirm}
            className="rounded-full bg-[#b00020] px-4 py-1.5 text-[13px] font-semibold text-[#fffefb] transition-colors hover:bg-[#8e0019]"
          >
            确认删除
          </button>
        </div>
  ...
  return (
    ...
    >
      <div
        ...
        aria-label="快速新建项目"
        tabIndex={-1}
        className="relative w-full max-w-xl overflow-hidden rounded-[30px] border border-[#c5c0b1] bg-[linear-gradient(180deg,#fffefb_0%,#fffdf9_55%,#eceae3_100%)] p-6 text-[#201515]"
      >
        ...
        <div className="relative mt-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="min-h-[108px] w-full rounded-[20px] border border-[#c5c0b1] bg-[#fffdf9] px-3 py-3 text-sm leading-6 text-[#201515] transition-colors outline-none focus:border-[#ff4f00]/35"
            />
          </div>

          <div className="rounded-[24px] border border-dashed border-[#c5c0b1] bg-[#fffefb]/80 p-4">
            ...
            <label className="mt-3 inline-flex cursor-pointer items-center gap-2 rounded-full border border-[#c5c0b1] bg-[#fffdf9] px-4 py-2 text-sm font-medium text-[#36342e] transition-colors hover:border-[#c5c0b1] hover:bg-[#fffefb]">
            ...
            {files.length > 0 ? (
              <div className="mt-3 rounded-[18px] border border-[#c5c0b1] bg-[#fffdf9] px-3 py-2">
  ...
  return (
    ...
    >
      <div
        ...
        aria-label="搜索结果弹窗"
        tabIndex={-1}
        className="relative w-full max-w-lg overflow-hidden rounded-[30px] border border-[#c5c0b1] bg-[linear-gradient(180deg,#fffefb_0%,#fffdf9_55%,#eceae3_100%)] p-6 text-[#201515]"
      >
        <div className="pointer-events-none absolute inset-x-0 top-0 h-24 bg-[radial-gradient(circle_at_top,#ff4f0033,transparent_70%)]" />
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2">
          <button
            ...
            className="rounded-2xl border border-[#c5c0b1] bg-[#fffefb] p-4 text-left transition-all hover:-translate-y-0.5 hover:bg-[#eceae3]"
          >
