...
export function EmailReviewModal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-[#201515]/26 px-4 backdrop-blur-[2px]">
      ...
      <div className="relative flex max-h-[86vh] w-full max-w-[720px] flex-col overflow-hidden rounded-[28px] border border-[#c5c0b1] bg-[#fffdf9]">
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4">
          <div className="grid gap-2.5 sm:grid-cols-4">
            <div className="rounded-[18px] border border-[#c5c0b1] bg-[#fffefb] px-3 py-2.5">
          ...
          <div className="mt-3 rounded-[22px] border border-[#c5c0b1] bg-[#fffefb] p-3">
          ...
          <div className="mt-3 rounded-[22px] border border-[#c5c0b1] bg-[#fffefb] p-3">
            <div className="mb-2 flex items-center justify-between gap-2">
              <div className="text-xs font-semibold text-[#201515]">邮件标题</div>
              <span
                className={`${EMAIL_PERSONALIZED_BADGE_CLASSES} px-2 py-0.5 text-[10px] font-semibold`}
              >
                标题也会替换姓名
              </span>
            </div>
          ...
          <div className="mt-3 rounded-[22px] border border-[#c5c0b1] bg-[#fffefb] p-3">
            <div className="mb-2 flex items-center justify-between gap-2">
              <div className="text-xs font-semibold text-[#201515]">邮件正文</div>
              <span
                className={`${EMAIL_PERSONALIZED_BADGE_CLASSES} px-2 py-0.5 text-[10px] font-semibold`}
              >
                {highlightCount} 处个性化
        ...
        <div className="flex items-center justify-between gap-3 border-t border-[#c5c0b1] bg-[#fffefb] px-5 py-4">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <button
              type="button"
              onClick={onClose}
              className="h-9 rounded-full border border-[#c5c0b1] bg-[#fffefb] px-4 text-sm font-semibold text-[#36342e] transition-colors hover:bg-[#eceae3]"
            >
              返回修改
            </button>
            <button
              type="button"
              onClick={onConfirm}
              className="inline-flex h-9 items-center gap-1.5 rounded-full bg-[#ff4f00] px-4 text-sm font-semibold text-[#fffefb] transition-all hover:bg-[#ff4f00] active:scale-[0.98]"
            >
