    ...
    <div className="mb-5 rounded-[22px] border border-[#e8e6dc] bg-[linear-gradient(135deg,#ffffff_0%,#faf9f5_58%,#f5f1e8_100%)] px-4 py-3.5 shadow-[0_8px_28px_-20px_rgba(20,20,19,0.18)]">
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex min-w-0 items-center gap-2">
          ...
          <div className="group/tip relative inline-flex shrink-0 cursor-default items-center text-[#c96442] select-none">
            <Target className="h-3.5 w-3.5 animate-[pulse_2s_ease-in-out_infinite]" />
            <span
              role="tooltip"
              className="pointer-events-none absolute top-full left-0 z-50 mt-2 w-64 rounded-[12px] border border-[#e8e6dc] bg-white px-3 py-2 text-[12px] leading-[1.6] text-[#4d4c48] opacity-0 shadow-[0_12px_30px_-18px_rgba(77,76,72,0.3)] transition-opacity duration-150 group-hover/tip:opacity-100"
            >
              {guidance}
            </span>
          </div>
          ...
          <div className="flex min-w-0 items-center">
            <div className="flex min-w-0 items-center rounded-full border border-[#e8e6dc] bg-white px-2.5 py-1.5 shadow-[0_8px_20px_-18px_rgba(20,20,19,0.32)]">
              <span className="min-w-0 truncate text-[13px] leading-tight font-semibold tracking-[-0.01em] text-[#141413] sm:text-[14px]">
                {currentProject.name}
              </span>

              <div className="relative ml-1.5 shrink-0 pl-1.5 before:absolute before:top-1/2 before:left-0 before:h-4 before:w-px before:-translate-y-1/2 before:bg-[#ece8de]">
          ...
          <div className="group/edit relative shrink-0">
            ...
            <span className="pointer-events-none absolute top-full left-1/2 z-50 mt-1.5 -translate-x-1/2 rounded-lg bg-[#141413] px-2 py-0.5 text-[11px] whitespace-nowrap text-white opacity-0 transition-opacity group-hover/edit:opacity-100">
              编辑项目
            </span>
          </div>
          ...
          <div className="group/new relative shrink-0">
            ...
            <span className="pointer-events-none absolute top-full left-1/2 z-50 mt-1.5 -translate-x-1/2 rounded-lg bg-[#141413] px-2 py-0.5 text-[11px] whitespace-nowrap text-white opacity-0 transition-opacity group-hover/new:opacity-100">
              新建项目
            </span>
          </div>
        </div>
