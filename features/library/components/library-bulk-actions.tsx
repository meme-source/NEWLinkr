...
// 弹层壳：Bar 在 sticky bottom，所以 popover 朝上展开。
function Popover({
  open,
  onClose,
  children,
  ...
  return (
    <>
      ...
      <div className="absolute bottom-full left-1/2 z-40 mb-2 w-[260px] -translate-x-1/2 rounded-2xl border border-[#c5c0b1] bg-[#fffefb] p-3">
        {children}
      </div>
    </>
  );
          ...
          <div className="max-h-[240px] overflow-y-auto">
            {candidates.map((project) => (
              <button
                ...
                className="flex w-full items-center justify-between gap-2 rounded-xl px-2.5 py-1.5 text-left text-[12px] text-[#36342e] transition-colors hover:bg-[#fffdf9]"
              >
        ...
        <div>
          {COLLABORATION_STATUS_ORDER.map((status) => (
            <button
              ...
              className="flex w-full items-center gap-2 rounded-xl px-2.5 py-1.5 text-left text-[12px] text-[#36342e] transition-colors hover:bg-[#fffdf9]"
            >
