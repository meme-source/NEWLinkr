...
export function MailbarAccountRow({ account, onConnect, onDisconnect }: MailbarAccountRowProps) {
  ...
  if (!account.connected) {
    return (
      <div className="flex items-center justify-between gap-3 rounded-xl border border-dashed border-[#c5c0b1] bg-[#fffdf9] px-4 py-3">
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between gap-3 rounded-xl border border-[#c5c0b1] bg-[#fffdf9] px-4 py-2.5">
      ...
      {confirmDisconnect ? (
        <div className="flex items-center justify-between gap-3 rounded-xl border border-red-100 bg-red-50 px-4 py-2.5 text-xs">
